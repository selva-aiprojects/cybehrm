      ...
      <header>
        <div className="topbar">
          <div className="brand">
            ...
            <img 
              src="/logo.png" 
              alt="CogniHRM — Intelligent Human Capital Management" 
              onError={(e) => { 
                e.currentTarget.style.display = 'none'; 
                e.currentTarget.parentElement!.innerHTML = '<span style="color:var(--primary);font-weight:bold;font-size:20px;letter-spacing:-0.5px;">CogniHR</span>'; 
              }} 
            />
          </div>
          <nav>
      ...
      <section className="hero">
        <div className="hero-grid">
          <div>
            ...
            <p className="lead">CogniHRM runs attendance, payroll, statutory tax, benefits, hiring, and exits in a single platform — so nothing gets approved twice and nothing slips through unrecorded.</p>
      ...
      <section id="workflows">
        <div className="wrap">
          <div className="section-head reveal">
            ...
            <p>Two of the longer workflows in CogniHRM, end to end — every step owned by a named role.</p>
          </div>
      ...
      <footer>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <img 
            ...
            onError={(e) => { 
              e.currentTarget.style.display = 'none'; 
              e.currentTarget.parentElement!.innerHTML = '<span style="color:var(--primary);font-weight:bold;font-size:14px;letter-spacing:-0.5px;">CogniHR</span>'; 
            }} 
          />
        </div>
        <div className="fmeta" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <span>© 2026 COGNIHRM · MULTI-TENANT HRMS · SUPABASE · RENDER</span>
